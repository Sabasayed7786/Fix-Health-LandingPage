...
import { doctorsData, city_data } from "../../services/Api";
...
const BookingForm = () => {
    ...
    switch (step) {
      ...
      case 5:
        const filteredDoctors = doctors.filter(
          (doctor) => doctor.city === formData.city
        );
  ...
  return (
    <div className="booking-form">
      <h3 style={{ marginBottom: "10px", color: "rgb(92, 156, 184)" }}>
        Book your first Appointment for FREE!
      </h3>
      <h4 style={{ marginBottom: "20px", color: "grey" }}>
